...
exports.config = exports.UPDATE_NOTIFICATIONS_OPT_OUT_CONFIG_TAG = void 0;
const utils_1 = require("@genkit-ai/tools-common/utils");
const clc = __importStar(require("colorette"));
const commander_1 = require("commander");
exports.UPDATE_NOTIFICATIONS_OPT_OUT_CONFIG_TAG = 'updateNotificationsOptOut';
const CONFIG_TAGS = {
    ...
    [exports.UPDATE_NOTIFICATIONS_OPT_OUT_CONFIG_TAG]: (value) => {
        let o;
        try {
            o = JSON.parse(value);
        }
